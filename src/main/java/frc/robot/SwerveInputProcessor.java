...
public class SwerveInputProcessor {
    private final SlewRateLimiter xLimiter = new SlewRateLimiter(1.0);
    private final SlewRateLimiter yLimiter = new SlewRateLimiter(1.0);
    ...
    public Translation2d getProcessedTranslation(CommandXboxController controller) {
        ...
        Vector<N2> curvedVector = MathUtil.copyDirectionPow(inputVector, 3.0, 1);
